...
const books = [
  { id: "hindi-1", title: "Godan", author: "Munshi Premchand", cover: "https://images.unsplash.com/photo-1589829085413-56de8ae18c73?q=80&w=400&fit=crop" },
  { id: "hindi-2", title: "Madhushala", author: "Harivansh Rai Bachchan", cover: "https://images.unsplash.com/photo-1541963463532-d68292c34b19?q=80&w=400&fit=crop" },
  { id: "hindi-3", title: "Raag Darbari", author: "Shrilal Shukla", cover: "https://images.unsplash.com/photo-1544947950-fa07a98d237f?q=80&w=400&fit=crop" },
  { id: "hindi-4", title: "Gunahon Ka Devta", author: "Dharamvir Bharati", cover: "https://images.unsplash.com/photo-1614728423169-3f65fd722b05?q=80&w=400&fit=crop" },
];

export function HindiSahitya() {
  return (
